...
//    NSString *classnName = @"TuanDaiV4.TDWBaseViewController";
//    Class class1 = NSClassFromString(classnName);
//    NSLog(@"cls=%@---class1=%@",cls,class1);
    if (![cls isSubclassOfClass:[UINavigationController class]]){//将导航栏控制器剔除
//        if (![cls isKindOfClass:[class1 class]]) {
           // NSLog(@"------------------------");
